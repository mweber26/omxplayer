...
LDFLAGS+=-L./ -Lffmpeg_compiled/usr/local/lib/ -lc -lWFC -lGLESv2 -lEGL -lbcm_host -lopenmaxil -lfreetype -lz `pkg-config --libs freetype2` `pkg-config --libs dbus-1` -L/opt/vc/lib

INCLUDES+=-I./ -Iffmpeg_compiled/usr/local/include/ -I./linux/ -I/opt/vc/include/interface/vmcs_host/linux/ `pkg-config --cflags freetype2` `pkg-config --cflags dbus-1`
